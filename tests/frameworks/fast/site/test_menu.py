from awesome_panel_extensions.frameworks.fast.site.menu import Menu, MenuCategory, MenuDivider, MenuItem
...
def test_menu_real_life_example():
    # Given
    items = [
        MenuCategory(name="Home", expanded=True, items=[
            MenuItem(name="Home", url="/")
        ]),
        MenuCategory(name="Apps", expanded=False, items=[
            MenuItem(name="App1", url="app1"),
            MenuDivider(),
            MenuItem(name="App2", url="app2")
        ]),
        MenuCategory(name="Resources", items=[
            MenuCategory(name="Panel", items=[
                MenuItem(name="Panel1", url="panel1"),
                MenuItem(name="Panel2", url="panel2"),
            ]),
            MenuCategory(name="Bokeh", items=[
