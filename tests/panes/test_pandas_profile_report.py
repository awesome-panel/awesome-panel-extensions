...
def test_app():
    ...
    # profile_report = None
    pandas_profile_report = PandasProfileReport(profile_report=profile_report, width=800, height=700)
    settings_pane = pn.Param(pandas_profile_report, parameters=["height", "width", "sizing_mode", "object_when_no_report", "object_when_loading_report"], background="lightgray", show_name=False)
    return pn.Column("# Settings", settings_pane, "# PandasProfileReport Extension", pandas_profile_report, sizing_mode="stretch_both")
