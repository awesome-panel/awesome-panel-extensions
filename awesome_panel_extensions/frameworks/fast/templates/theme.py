...
class FastStyle(param.Parameterized):
    ...
    def create_bokeh_theme(self):
        ...
        "attrs": {
            "Figure": {
                "background_fill_color": self.background_color, # "#181818", # var(----background-color)
                "border_fill_color": self.neutral_fill_card_rest, # "#212121", # var(--neutral-fill-card-rest)
                "outline_line_color": self.neutral_focus, # "#717171", # var(--neutral-focus)
...
# FAST_FONT = "Open Sans, sans-serif"
# FAST_DEFAULT_THEME = {
#         "attrs": {
#             "Figure": {
#                 "background_fill_color": DEFAULT_STYLE.background_color,
#                 "border_fill_color": DEFAULT_STYLE.neutral_fill_card_rest, # var(--neutral-fill-card-rest)
#                 "outline_line_color": "black",
#                 "outline_line_alpha": 0.25,
#             },
#             "Axis": {
#                 "major_label_text_font": FAST_FONT,
#                 "major_label_text_font_size": "1.025em",
#                 "axis_label_standoff": 10,
#                 "axis_label_text_font": FAST_FONT,
#                 "axis_label_text_font_size": "1.25em",
#                 "axis_label_text_font_style": "normal",
#             },
#             "Legend": {
...
#                 "glyph_width": 15,
#                 "label_standoff": 8,
#                 "label_text_font": FAST_FONT,
#                 "label_text_font_size": "1.025em",
#             },
#             "ColorBar": {
#                 "title_text_font": FAST_FONT,
#                 "title_text_font_size": "1.025em",
#                 "title_text_font_style": "normal",
#                 "major_label_text_font": FAST_FONT,
#                 "major_label_text_font_size": "1.025em",
...
#         "attrs": {
#             "Figure": {
#                 "background_fill_color": "#181818", # var(----background-color)
#                 "border_fill_color": "#212121", # var(--neutral-fill-card-rest)
#                 "outline_line_color": "#717171", # var(--neutral-focus)
#                 "outline_line_alpha": 0.55,
#                 "outline_line_width": 1,
#             },
#             "Grid": {"grid_line_color": "self.neutral_foreground_rest", "grid_line_alpha": 0.25},
#             "Axis": {
#                 "major_tick_line_alpha": 0,
#                 "major_tick_line_color": self.neutral_foreground_rest,
#                 "minor_tick_line_alpha": 0,
