"""The IconButton extends the `panel.widgets.Button` with support for Icons

    Please note that when the Panel gets extended to support Icons the IconButton will be
    removed.
"""
...
class IconButton(_PnButton):
    """The IconButton extends the Panel Button with support for Icons
    ...
    ...     icon = icon
    ... )
    IconButton(_bk_icon=Icon(id='...', ...), icon=Icon, name='Click Me')
